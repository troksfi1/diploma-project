...
právě architektura toho frameworku, která bude doplněna o drobné rozdíli mezi těmito dvěma frameworky. 

Renderovací část UI se skládá z následující tří fází:
...
právě počet a vyspělost se podle společností, které již KMP používají ukazuje jako zatim jedna z nejslabších stránek (viz kapitola \ref{kmpInPractise}).
...
Nejprve je ve společné části potřeba například třídu, funkci  
...
Většina výše zmíněných problémů se již řeší a je zmíněna v Kotlin Multiplatform vývojářském plánu pro rok 2024. \cite{KMPRoaddMap}
