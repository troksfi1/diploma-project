...
vizualizuje vzájemnou propojenost frameworku Compsose Multiplatfom s toolkitem Kotlin Multiplatfom (KMP). Dále vizualizuje 
použití platformě specifických knihoven pro tvorbu UI (SwiftUI)

Compose lze nicméně použít i s dříve používanými technologiemi pro tvorbu UI jako je UI kit v případě platformy iOS nebo
Android views v případě platformy iOS. 
