...
Uživatelé mohou prostřednictvím aplikace získat přístup k aktuálním novinkám, událostem a důležitým oznámením ze svého města nebo obce. 
Tato funkce umožní občanům zůstat informováni o dění ve svém okolí.

\myparagraph{UC2 Zobrazení aktuálních událostí} 
Aplikace poskytne uživatelům přehled o připravovaných akcích, událostech a kulturních aktivitách v jejich městě nebo obci. Uživatelé budou moci 
procházet kalendář akcí, filtrovat je podle svých zájmů a získat podrobnosti o jednotlivých událostech.
...
\myparagraph{UC8 Platba parkovného} 
