...
I přesto, že je náročnost implementace do jisté míry subjektivní záležitostí, tak existuje několik málo důvodů, které mohou k porovnání 
...
Po vybrání typu aplikace následuje podkapitola věnující návrh vhodných případů užití, které je vhodné specifikovat jednak aby bylo zřejmé jací 
...
rozebrání jednotlivých vrstev. 

jednak grafické podoby aplikace, tak 
