...
Android views pro platformu Android. Každopádně, od těchto technologií je postupně upouštěno a přechází se k~deklarativním frameworkům jako je Jetpack Compose nebe SwiftUI.  
...
Dále se adresáře mohou dělit podle vybrané platformy jako například \code{AndroidMain}, \code{iosMain}, které již mohou být závislé na pouze platformě specifický knihovnách.
