...
% Většinu cílů, které byly stanoveny v~zadání bylo možné pomocí multiplatformního frameworku Compose Multiplatform splnit a nebylo tak
% nutné přistupovat na kompromisy.
% Nicméně při implementacni náročnějších částí aplikace bylo již v někteých případech nutné přistoupit k~použití nativních řešení a 
% tím pádem tyto dva přístupy zkombinovat.
% Ve výsledku z~poheledu UI, tak tato kombinace nevedla k~žádným ústupkům
